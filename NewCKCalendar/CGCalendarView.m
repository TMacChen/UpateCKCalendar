...
@property (nonatomic, strong) CGDateItem *dateItem;
...
- (void)layoutWithFirstDay:(CGCalendarStartDay)firstDay {
...
- (instancetype)initWithStartDay:(CGCalendarStartDay)firstDay frame:(CGRect)frame {
    ...
    if (self) {
        [self layoutWithFirstDay:firstDay];
    }
    return self;
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        [self layoutWithFirstDay:startSunday];
    }
    return self;
}
...
- (void)layoutSubviews {
    ...
    while ([date laterDate:endDate] != date) {
        ...
        CGDateItem *item = [[CGDateItem alloc] init];
...
- (void)setCalendarStartDay:(CGCalendarStartDay)calendarStartDay {
...
- (void)setMonthButtonColor:(UIColor *)color {
    [self.prevButton setImage:[CGCalendarView imageNamed:@"left_arrow.png" withColor:color] forState:UIControlStateNormal];
    [self.nextButton setImage:[CGCalendarView imageNamed:@"right_arrow.png" withColor:color] forState:UIControlStateNormal];
}
